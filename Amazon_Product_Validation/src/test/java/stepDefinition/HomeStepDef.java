...
public class HomeStepDef {
    ...
    public void i_open_the_product_page_for_specified_product_id() throws PendingException {
        Assert.assertTrue(tcs.pom.getHome().navigateToProductPage());
    }

    @Then("I should see the Buy Now button")
    public void i_should_see_the_button() throws PendingException {
    ...
    public void i_should_check_if_customer_rating_for_the_product_is_over_four() throws PendingException{
        tcs.pom.getHome().checkCustomerRatings();
    }

    @Then("Print all the offers available on the description page for the product")
    public void print_all_the_offers_available_on_the_description_page_for_the_product() throws PendingException {
